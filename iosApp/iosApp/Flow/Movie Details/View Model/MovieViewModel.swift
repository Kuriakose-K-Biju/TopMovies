...
class MovieViewModel: ObservableObject {
    ...
    func getDetails() {
        ...
        let getMovieApiCall = ApiHandler.callApi(GetMovieDetails(movieId: "278"))
        let getCastApiCall = ApiHandler.callApi(GetCastDetails(movieId: "278", queryParams: ["language": "en-US"]))
